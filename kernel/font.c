...
uint8_t font8x8[128][8] = {
    ...
    [73] = {0x3E, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x3E, 0x00}, // I
    ...
    // lowercase (mapping identical to uppercase for simplicity right now)
    [97] = {0x3C, 0x66, 0x66, 0x7E, 0x66, 0x66, 0x66, 0x00}, // a
    [98] = {0x7C, 0x66, 0x66, 0x7C, 0x66, 0x66, 0x7C, 0x00}, // b
    [99] = {0x3C, 0x66, 0x60, 0x60, 0x60, 0x66, 0x3C, 0x00}, // c
    [100]= {0x78, 0x6C, 0x66, 0x66, 0x66, 0x6C, 0x78, 0x00}, // d
    [101]= {0x7E, 0x60, 0x60, 0x78, 0x60, 0x60, 0x7E, 0x00}, // e
    [102]= {0x7E, 0x60, 0x60, 0x78, 0x60, 0x60, 0x60, 0x00}, // f
    [103]= {0x3C, 0x66, 0x60, 0x6E, 0x66, 0x66, 0x3C, 0x00}, // g
    [104]= {0x66, 0x66, 0x66, 0x7E, 0x66, 0x66, 0x66, 0x00}, // h
    [105]= {0x3E, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x3E, 0x00}, // i
    [106]= {0x06, 0x06, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00}, // j
    [107]= {0x66, 0x6C, 0x78, 0x70, 0x78, 0x6C, 0x66, 0x00}, // k
    [108]= {0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x7E, 0x00}, // l
    [109]= {0x63, 0x77, 0x7F, 0x6B, 0x63, 0x63, 0x63, 0x00}, // m
    [110]= {0x66, 0x76, 0x7E, 0x7E, 0x6E, 0x66, 0x66, 0x00}, // n
    [111]= {0x3C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00}, // o
    [112]= {0x7C, 0x66, 0x66, 0x7C, 0x60, 0x60, 0x60, 0x00}, // p
    [113]= {0x3C, 0x66, 0x66, 0x66, 0x6A, 0x6C, 0x3A, 0x00}, // q
    [114]= {0x7C, 0x66, 0x66, 0x7C, 0x6C, 0x66, 0x66, 0x00}, // r
    [115]= {0x3C, 0x66, 0x60, 0x3C, 0x06, 0x66, 0x3C, 0x00}, // s
    [116]= {0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00}, // t
    [117]= {0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00}, // u
    [118]= {0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x00}, // v
    [119]= {0x63, 0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63, 0x00}, // w
    [120]= {0x66, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x66, 0x00}, // x
    [121]= {0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x00}, // y
    [122]= {0x7E, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x7E, 0x00}  // z
};